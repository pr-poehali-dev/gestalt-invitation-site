...
const STUDENTS_IMG = "https://cdn.poehali.dev/projects/a6fb0e7f-e44b-4597-8b80-f26e820765c9/files/667b7230-1ee8-4a5f-a505-1b94ef64b401.jpg";
  ...
  return (
    <div className="min-h-screen bg-cream font-body overflow-x-hidden">
      ...
      <section id="modules" className="py-28 relative overflow-hidden" style={{ background: "hsl(25, 30%, 18%)" }}>
        <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: "url('https://cdn.poehali.dev/projects/a6fb0e7f-e44b-4597-8b80-f26e820765c9/files/19a3e1ab-695a-4dd4-8e33-9fcf84446849.jpg')" }} />
        <div className="absolute inset-0" style={{ background: "linear-gradient(to right, hsl(25,30%,18%) 0%, hsl(25,30%,18%,0.7) 40%, transparent 70%)" }} />
